...
from GAT import GATPolicy_multitask_x3 as GATPolicy
...
def train(epoch, predict, data_loader1, data_loader2, optimizer1=None, optimizer2=None, weight_norm=1):
    ...
    while True:
        ...
        with torch.set_grad_enabled(optimizer1 is not None):
            ...
            if optimizer1 is not None:
                ...
                writer.add_scalar('valid_loss5', loss5, epoch)
            mean_loss5 += loss5
    ...
    mean_loss = (mean_loss1 + mean_loss3 + mean_loss5) / 3 + mean_loss2 + mean_loss4 + mean_loss6
