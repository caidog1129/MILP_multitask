...
class GATPolicy(torch.nn.Module):
    ...
    def forward(self, constraint_features, edge_indices, edge_features, variable_features, variable_features_batch, constraint_features_batch):
        ...
        for group in softmax_groups:
            ...
            final_output[..., group] = softmax_output  # Replace the group logits with softmax outputs
    
        # Return the final output where certain groups sum to 1
        return final_output  # [batch_size, 33]
